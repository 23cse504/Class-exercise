...
public class kesavChildren {
    ...
    public kesavChildren() {
    }
    public kesavChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
